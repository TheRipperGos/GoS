...
require "DamageLib"
	...
	Legendary.Heal.Items.TBS:MenuElement({id = "HP", name = "If my HP less than (%)", value = 60, min = 0, max = 100})
	...
	Legendary.Heal.Items.RPS:MenuElement({id = "HP", name = "If my HP less than (%)", value = 60, min = 0, max = 100})
	...
	Legendary.Heal.Items.HSPS:MenuElement({id = "HP", name = "If my HP less than (%)", value = 60, min = 0, max = 100})
